...
![Chatbot Hero Banner](/assets/portfolio-img/chatbot/hero-banner.png)
...
![Agent Workflow Pain Points](/assets/portfolio-img/chatbot/problem-statement.webp)
...
<div markdown="1" style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin: 2rem 0;">
  <div markdown="1">
  ...
  <div markdown="1">
    ...
    <img src="/assets/portfolio-img/chatbot/workshop-user-stories.webp" alt="User Stories Mapping" style="width: 100%;">
  </div>
</div>
...
<div markdown="1" style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin: 2rem 0;">
  ...
  <div markdown="1">
    <p><strong>📤 Workshop Outcome:</strong></p>
    <img src="/assets/portfolio-img/chatbot/workshop-core-feature.webp" alt="Core Feature Mapping" style="width: 100%;">
  </div>
</div>
...
![User Experience Journey](/assets/portfolio-img/chatbot/workshop-ux-mapping.webp)

![Conversation Flow Design](/assets/portfolio-img/chatbot/ux-core-experience.png)

<div markdown="1" style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin: 2rem 0;">
  <div markdown="1">
    <img src="/assets/portfolio-img/chatbot/agent-hand-off.webp" alt="Flow Details 1" style="width: 100%;">
  </div>
  <div markdown="1">
    <img src="/assets/portfolio-img/chatbot/edge-case.webp" alt="Flow Details 2" style="width: 100%;">
  </div>
</div>
...
<div markdown="1" style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin: 2rem 0;">
  ...
  <div markdown="1">
    ...
    <img src="/assets/portfolio-img/chatbot/lovable-demo.webp" alt="Lovable Prototype" style="width: 100%;">
  </div>
</div>
...
<div markdown="1" style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin: 2rem 0;">
  ...
  <div markdown="1">
    <img src="/assets/portfolio-img/chatbot/techneed.webp" alt="Semantic Routing Architecture" style="width: 100%;">
  </div>
</div>
...
<div markdown="1" style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin: 2rem 0;">
  ...
  <div markdown="1">
    <img src="/assets/portfolio-img/chatbot/integration-point.webp" alt="Integration Architecture" style="width: 100%;">
  </div>
</div>
...
![MVP Dashboard](/assets/portfolio-img/chatbot/mvp-look-feel.webp)

<div markdown="1" style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin: 2rem 0;">
  <div markdown="1">
    <img src="/assets/portfolio-img/chatbot/upskill.webp" alt="Chat Interface 1" style="width: 100%;">
  </div>
  <div markdown="1">
    <img src="/assets/portfolio-img/chatbot/realtime-assistance.webp" alt="Chat Interface 2" style="width: 100%;">
  </div>
</div>
...
![Results Dashboard](/assets/portfolio-img/chatbot/mvp-analytics-1.png)
